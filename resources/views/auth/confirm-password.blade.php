            ...
            <div class="container py-4">
                <div class="p-5 mb-4 bg-body-tertiary rounded-3">
                    <div class="container-fluid py-5">
                        <h3>Inserisci la Password per confermare la tua identità</h3>
                        @if ($errors->any())
                            <ul>
                        ...
                        <form action="{{ route('password.confirm.store') }}" method="POST">
                            ...
                            <button class="btn btn-secondary my-2" type="submit">Conferma Password</button>
                        </form>
                        <hr>
                        <a class="btn btn-sm btn-outline-secondary mx-2" href="{{ url()->previous() }}">Indietro</a>
                    </div>
                </div>
            </div>
        </main>
